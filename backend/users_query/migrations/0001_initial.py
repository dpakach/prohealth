# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-06 11:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users_query.Medicine')),
            ],
        ),
        migrations.CreateModel(
            name='UserQuery',
            fields=[
                ...
                ('description', models.TextField()),
                ('file_related', models.FileField(blank=True, upload_to=users_query.models.get_file_path)),
